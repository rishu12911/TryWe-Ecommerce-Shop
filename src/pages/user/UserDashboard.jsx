    ...
    return (
        <Layout>
            <div className="container mx-auto px-4 py-5 lg:py-8">
                ...
                <div className="top ">
                    {/* main  */}
                    <div className="bg-black-50 py-5 rounded-xl border border-black-100" style={{background: 'linear-gradient(to bottom right, black, white)'}}>
                        {/* image  */}
                                    ...
                                    {order.cartItems.map((item, index) => {
                                        ...
                                        return (
                                            <div key={index} className="mt-5 flex flex-col overflow-hidden rounded-xl border border-black md:flex-row">
                                                {/* main 3  */}
                                                <div className="w-full border-r border-black bg-black-50 md:max-w-xs" style={{background: 'linear-gradient(to bottom right, black, white)'}}>
                                                    {/* left  */}
                                                    <div className="p-8">
                                                        <div className="grid grid-cols-2 sm:grid-cols-4 md:grid-cols-1">
                                                            ...
                                                            <div className="mb-4">
                                                                ...
                                                                <div className={`text-sm font-medium ${status === 'pending' ? 'text-red-800' : 'text-green-800'} first-letter:uppercase`}>{status}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
