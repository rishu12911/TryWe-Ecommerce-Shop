    ...
    *========================================================================**/
    ...
    return (
        <div className='flex justify-center items-center h-screen bg-black text-white'>
            {loading && <Loader/>}
            {/* Signup Form  */}
            <div className="signup_Form bg-black px-8 py-6 border border-gray-900 rounded-xl shadow-md">
                ...
                <div className="mb-3">
                    <input
                        ...
                        className='bg-black border border-gray-900 px-2 py-2 w-96 rounded-md outline-none placeholder-red-500 text-white'
                    />
                </div>
